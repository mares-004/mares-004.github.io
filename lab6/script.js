...
(function() {
    ...
    console.log("\n----- Exercise 3, Part 1 -----");
    const teacher = new Person("Prof. Sami");
    teacher.teach("WAP");
})();
...
(function() {
    ...
    console.log("\n----- Exercise 3, Part 2 -----");
    const teacher = personFactory("Prof. Sami");
    teacher.teach("WAP");
})();
...
(function() {
    ...
    const student = studentFactory("Raul", 26, "WAP");
    student.greet();
    student.salute();

    const professor = professorFactory("Prof. Sami", 50, "Computer Science");
    professor.greet();
    professor.salute();
})();
...
(function() {
    ...
    const student = new Student("Raul", 26, "WAP");
    student.greet();
    student.salute();
    ...
    const professor = new Professor("Prof. Sami", 50, "Computer Science");
    professor.greet();
    professor.salute();
})();
...
(function() {
    ...
    const professor = new Professor("Prof. Sami");
